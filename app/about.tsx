...
function About() {
  ...
  return (
    <div id="main" className="w-full relative min-h-screen flex flex-col justify-center items-center p-8">
    <div className="fixed w-full min-h-screen flex flex-col justify-center items-center p-8" style = {{backgroundColor: "rgb(37, 22, 56)"}}>
        ...
        <div className="absolute bottom-0 left-0 flex align-item flex-end">
            <svg width="500" height="232" viewBox="0 0 500 232" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero-background-asset1">
                <path d="M0 232V14.5002C9.16667 2.16685 66.5 -9.5 86.5 14.5001C98.7523 29.203 136.752 64.0002 158.5 130.5C184.5 210 337.2 151.3 386 170.5C430.8 179.7 427.833 196.334 500 230H0Z" fill="rgb(101,77,228)" fill-opacity="0.6"></path>
            </svg>
        </div>

        {/* the blob on the right side */}
        <div className = {"absolute top-0 right-0 flex justify-content flex-end"}>
            <svg width="300" height="700" viewBox="0 0 300 700" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero-background-asset2">
                <path d="M500 0V230V200C500 300 400 700 230 500C200 100 50 250 50 100C50 50 -20 35 12 0H400Z" fill="rgb(168,104,240)" fill-opacity="0.6">
                </path>
            </svg>
        </div>
        ...
        <a
            ...
            className="z-10 border text-lg text-[rgb(168,104,240)] bg-white px-5 py-2 rounded-full shadow-md font-bold hover:bg-[rgb(168,104,240)] hover:text-white transition-all duration-300"
