    ...
    >
      <div className="max-w-6xl mx-auto space-x-10 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-7 text-white text-base font-semibold">
          ...
          <a className="relative group" href="#events">
        ...
        <div className="p-4 hidden md:flex space-x-3">
          <div className="flex justify-between space-x-5 px-2 py-1 rounded-sm">
            ...
            <a href="https://x.com/HighlanderEng">
              <Image src="/x.png" width={30} height={30} alt="x" unoptimized />
            </a>
          </div>
          <a
            href="https://drive.google.com/file/d/1_obaL-fZBsIYEoNH27RIvx_z9oRKUWIm/view"
            className="bg-gray-100 text-[#11171b] font-semibold px-4 py-2 rounded-sm"
          >
            Sponsor
          </a>
        </div>
      ...
      <div
        className={`fixed z-50 left-0 top-0 h-screen text-center md:hidden bg-gray-700 text-white p-4 transform ${
